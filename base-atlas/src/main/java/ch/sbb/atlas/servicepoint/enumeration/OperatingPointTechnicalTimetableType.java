...
public enum OperatingPointTechnicalTimetableType {
  ...
  INVESTMENT_LOCATIONS_OPERATING_POINT(60, true, "BP für Anlagestandorte DfA", "Point d’exploitations pour des "
      + "installations fixes",
      "Punto d’esercizio per gli impianti fissi DfA", "Operating point for fixed installations", "technischerfahrplan", "BDPfA",
      "PEDfA",
      "PEDfA", null),
  ...
  EX_STOP_POINT(15, true, "Ehemalige Haltestelle mit Infrastruktur", "Ancien arrêt avec infrastructure",
      "Precedente fermata con infrastruttura", "Former stop with infrastructure", "technischerfahrplan", "Hab", "aai", "pfi",
      null),
