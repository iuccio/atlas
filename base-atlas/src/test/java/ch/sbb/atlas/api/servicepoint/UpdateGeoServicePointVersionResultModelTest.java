...
class UpdateGeoServicePointVersionResultModelTest {
  ...
  void shouldGetResponseMessageWithNewVersions() {
    ...
    assertThat(resultModel.getResponseMessage()).isNotNull();
    assertThat(resultModel.getResponseMessage()).isEqualTo(
        "Generated additional versions: <br>before [UpdateGeoServicePointVersionResultModel.VersionDataRage"
            + "(validFrom=2000-01-01, validTo=2000-12-31), UpdateGeoServicePointVersionResultModel.VersionDataRage"
            + "(validFrom=2001-01-01, validTo=2001-12-31)] <br>after [UpdateGeoServicePointVersionResultModel.VersionDataRage"
            + "(validFrom=2000-01-01, validTo=2000-12-31), UpdateGeoServicePointVersionResultModel.VersionDataRage"
            + "(validFrom=2001-01-01, validTo=2000-06-01), UpdateGeoServicePointVersionResultModel.VersionDataRage"
            + "(validFrom=2001-06-02, validTo=2000-12-31)][SwissMunicipalityNumber=236,SwissMunicipalityName=Bern,"
            + "SwissLocalityName=Bern] differs from [SwissMunicipalityNumber=101,SwissMunicipalityName=Wyleregg,"
            + "SwissLocalityName=Wyleregg]");
  }
