...
class TimetableHearingStatementSenderModelV2Test extends BaseValidatorTest {
  ...
  @Test
  void whenValidEmails_thenNoConstraintViolation() {
  ...
  @Test
  void whenMoreThan10EmailsInSet_thenConstraintViolation() {
  ...
  @Test
  void whenNoEmails_thenConstraintViolation() {
  ...
  @Test
  void whenInvalidEmailForm_thenConstraintViolation() {
  ...
  @Test
  void whenEmailLenghtMoreThan100Characters_thenConstraintViolation() {
