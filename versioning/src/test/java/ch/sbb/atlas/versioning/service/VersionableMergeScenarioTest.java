...
public class VersionableMergeScenarioTest extends MergeBaseTest {
  ...
  public void scenarioMergeTwoVersions() {
    ...
    assertThat(propertyToBeIgnoredThirdVersionedObjectEntity.getValue()).isEqualTo(versionableObject3.getPropertyToBeIgnored());
  ...
  public void scenarioMergeThroughMultipleVersions(){
    ...
    List<VersionedObject> result = versionableService.versioningObjects(
        versionableObject2,
        editedVersion,
        List.of(versionableObject1, versionableObject2,versionableObject3,versionableObject4, versionableObject5));
    ...
    assertThat(propertyToBeIgnoredFourthVersionedObjectEntity.getValue()).isEqualTo(versionableObject4.getPropertyToBeIgnored());
    ...
    assertThat(propertyToBeIgnoredFifthVersionedObjectEntity.getValue()).isEqualTo(versionableObject5.getPropertyToBeIgnored());
