...
public class ServicePointServiceScenario2Test extends BaseServicePointServiceIntegrationTest{

    @Autowired
    public ServicePointServiceScenario2Test(ServicePointVersionRepository versionRepository,
    ...
    public void scenario2() {
        ...
        assertThat(fourthTemporalVersion.getDesignationOfficial()).isEqualTo("Bern, Thunplatz");
        assertThat(fourthTemporalVersion.getMeansOfTransport()).isEqualTo(Set.of(MeanOfTransport.TRAIN));
