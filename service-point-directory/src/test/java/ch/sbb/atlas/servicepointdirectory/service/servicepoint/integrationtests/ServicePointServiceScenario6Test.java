...
public class ServicePointServiceScenario6Test extends BaseServicePointServiceIntegrationTest{

    @Autowired
    public ServicePointServiceScenario6Test(ServicePointVersionRepository versionRepository,
