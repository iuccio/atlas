package ch.sbb.atlas.servicepointdirectory.module.shared.servicepoint.repository;
...
class SharedServicePointRepositoryTest {
  ...
  @Autowired
  private ServicePointDistributor.SharedServicePointRepository sharedServicePointRepository;
