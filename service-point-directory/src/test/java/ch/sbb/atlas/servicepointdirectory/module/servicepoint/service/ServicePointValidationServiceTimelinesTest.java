...
import ch.sbb.atlas.servicepointdirectory.module.servicepoint.ServicePointVersionsTimelineTestData;
...
class ServicePointValidationServiceTimelinesTest {
  ...
  void initMocksAndService() {
    ...
    servicePointValidationService = new ServicePointValidationService(sharedBusinessOrganisationServiceMock,
        servicePointVersionRepositoryMock);
    when(servicePointVersionRepositoryMock.findAllByNumberAndOperatingPointRouteNetworkTrueOrderByValidFrom(
        servicePointNumber)).thenReturn(getServicePointVersions());
  }
