...
public class OpenApiConfig {
  ...
  public GroupedOpenApi defaultApi() {
    return GroupedOpenApi.builder()
        .group("public")
        .packagesToScan("ch.sbb.atlas.servicepointdirectory")
        .build();
  }
  ...
  public OpenAPI openAPI() {
    return new OpenAPI()
        ...
        .info(new Info()
            .title("Service Point Directory API")
            .description("This is the API for all your needs on service point directory")
