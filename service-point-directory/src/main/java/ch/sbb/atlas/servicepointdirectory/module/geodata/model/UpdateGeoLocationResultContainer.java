package ch.sbb.atlas.servicepointdirectory.module.geodata.model;

import static ch.sbb.atlas.servicepointdirectory.module.geodata.helper.ServicePointGeoLocationUtils.getDiffServicePointGeolocationAsMessage;
