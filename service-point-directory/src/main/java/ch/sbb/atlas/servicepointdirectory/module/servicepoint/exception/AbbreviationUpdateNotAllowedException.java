...
public class AbbreviationUpdateNotAllowedException extends AtlasException {
  ...
  private static final String ABBREVIATION_UPDATE_NOT_ALLOWED = "The businessorganization of the service point is not permitted"
      + " to set an abbreviation, or the service point already has an abbreviation and cannot be updated or deleted.";
