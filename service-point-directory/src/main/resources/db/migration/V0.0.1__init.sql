...
(
    ...
    e_lv95                  INTEGER NULL,
    n_lv95                  INTEGER NULL,
    e_wgs84                 INTEGER NULL,
    n_wgs84                 INTEGER NULL,
    height                  INTEGER NULL,
    country_code            VARCHAR(2) NULL,
    swiss_municipality_name VARCHAR(100) NULL,
    swiss_canton_fso_number INTEGER NULL,
    swiss_canton_name       VARCHAR(100) NULL,
    swiss_canton_number     INTEGER NULL,
    swiss_district_name     VARCHAR(100) NULL,
    swiss_district_number   INTEGER NULL,
