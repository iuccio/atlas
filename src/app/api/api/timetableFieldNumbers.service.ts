/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:0.20.0-SNAPSHOT<br/>timetable-field-number:0.58.0-SNAPSHOT<br/>
 *
