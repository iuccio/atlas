/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:0.23.0-SNAPSHOT<br/>timetable-field-number:0.62.0-SNAPSHOT<br/>
 *
