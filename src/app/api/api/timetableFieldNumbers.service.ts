/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:0.27.0-SNAPSHOT<br/>timetable-field-number:0.70.0-SNAPSHOT<br/>
 *
 * The version of the OpenAPI document: 0.10.0-SNAPSHOT
...
export class TimetableFieldNumbersService {
  ...
  public createVersion(
    ...
    return this.httpClient.post<Version>(
      `${this.configuration.basePath}/timetable-field-number/v1/field-numbers`,
      version,
      {
  ...
  public getAllVersionsVersioned(
    ...
    return this.httpClient.get<Array<Version>>(
      ...
      }/timetable-field-number/v1/field-numbers/versions/${encodeURIComponent(String(ttfnId))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
