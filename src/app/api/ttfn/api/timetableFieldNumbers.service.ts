...
import { VersionsContainer } from '../model/models';
...
export class TimetableFieldNumbersService {
  ...
  public createVersion(
    ...
    return this.httpClient.post<Version>(
      `${this.configuration.basePath}/v1/field-numbers`,
      version,
      {
  ...
  public deleteVersion(
    ...
    return this.httpClient.delete<any>(
      `${this.configuration.basePath}/v1/field-numbers/${encodeURIComponent(String(id))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public getAllVersionsVersioned(
    ...
    return this.httpClient.get<Array<Version>>(
      `${this.configuration.basePath}/v1/field-numbers/versions/${encodeURIComponent(
        String(ttfnId)
      )}`,
      {
        responseType: <any>responseType_,
  ...
  public getVersions(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<HttpResponse<VersionsContainer>>;
  public getVersions(
    page?: number,
    size?: number,
    sort?: Array<string>,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<HttpEvent<VersionsContainer>>;
  public getVersions(
    page?: number,
    size?: number,
    sort?: Array<string>,
    ...
    return this.httpClient.get<VersionsContainer>(
      `${this.configuration.basePath}/v1/field-numbers`,
      {
  ...
  public updateVersionWithVersioning(
    ...
    if (version === null || version === undefined) {
      throw new Error(
        'Required parameter version was null or undefined when calling updateVersionWithVersioning.'
      );
    }
    ...
    return this.httpClient.put<Array<Version>>(
      `${this.configuration.basePath}/v1/field-numbers/versions/${encodeURIComponent(String(id))}`,
      version,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
