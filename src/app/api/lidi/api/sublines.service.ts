...
export class SublinesService {
  ...
  public createSublineVersion(
    ...
    return this.httpClient.post<SublineVersion>(
      `${this.configuration.basePath}/v1/sublines/version`,
      sublineVersion,
      {
  ...
  public deleteSublineVersion(
    ...
    return this.httpClient.delete<any>(
      `${this.configuration.basePath}/v1/sublines/version/${encodeURIComponent(String(id))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public getSubline(
    ...
    return this.httpClient.get<Array<SublineVersion>>(
      `${this.configuration.basePath}/v1/sublines/${encodeURIComponent(String(slnid))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public getSublines(
    ...
    return this.httpClient.get<ContainerSubline>(`${this.configuration.basePath}/v1/sublines`, {
