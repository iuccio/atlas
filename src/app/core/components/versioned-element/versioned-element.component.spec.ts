...
import { VersionedElementComponent } from './versioned-element.component';
...
describe('SwitchVersionComponent', () => {
  let component: VersionedElementComponent;
  let fixture: ComponentFixture<VersionedElementComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [VersionedElementComponent],
      imports: [
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(VersionedElementComponent);
