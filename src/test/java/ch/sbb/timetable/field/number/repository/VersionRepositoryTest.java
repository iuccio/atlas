...
public class VersionRepositoryTest {
    ...
    void setUpVersionWithTwoLineRelations() {
        version = Version.builder().ttfnid("ch:1:fpfnid:100000")
                                   ...
                                   .build();
        version.setLineRelations(new HashSet<>(Set.of(LineRelation.builder().slnid("ch:1:slnid:100000").version(version).build(),
    ...
    void shouldUpdateVersionWithAdditionalLineRelation() {
        //given
        version.getLineRelations().add(LineRelation.builder().slnid("ch:1:slnid:100002").version(version).build());
