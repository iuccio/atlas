...
import ch.sbb.exportservice.job.lidi.subline.MainlineService;
...
class MainlineServiceIntegrationTest extends BaseLiDiSqlIntegrationTest {
  ...
  void shouldAddMainlineAttributesToSubline() {
    ...
    Subline enrichedSubline = mainlineService.addMainlinePropertiesToSubline(subline);
