...
class ExportYearsTimetableUtilTest {

  @Test
  void shouldHaveCorrectDateRangeForTimetableYearsExportOnMarch2025() {
    DateRange result = ExportYearsTimetableUtil.getTimetableYearsDateRange(LocalDate.of(2025, 3, 18));
  ...
  void shouldHaveCorrectDateRangeForTimetableYearsExportOnDecember2025() {
    DateRange result = ExportYearsTimetableUtil.getTimetableYearsDateRange(LocalDate.of(2025, 12, 18));
    assertThat(result.getFrom()).isEqualTo(LocalDate.of(2025, 12, 14));
    assertThat(result.getTo()).isEqualTo(LocalDate.of(2027, 12, 11));


    result = ExportYearsTimetableUtil.getTimetableYearsDateRange(LocalDate.of(2025, 12, 15));
    assertThat(result.getFrom()).isEqualTo(LocalDate.of(2025, 12, 14));
    assertThat(result.getTo()).isEqualTo(LocalDate.of(2027, 12, 11));
  }
}