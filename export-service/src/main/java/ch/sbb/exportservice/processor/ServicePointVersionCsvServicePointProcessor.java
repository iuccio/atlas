...
public class ServicePointVersionCsvServicePointProcessor extends BaseServicePointProcessor implements
  ...
  public ServicePointVersionCsvModel process(ServicePointVersion version) {
    ...
    builder.operatingPointType(version.getOperatingPointType())
        ...
        .businessOrganisation(version.getBusinessOrganisationRelation().getBusinessOrganisation())
        .businessOrganisationNumber(version.getBusinessOrganisationRelation().getBusinessOrganisationNumber())
        .businessOrganisationAbbreviationDe(version.getBusinessOrganisationRelation().getBusinessOrganisationAbbreviationDe())
        .businessOrganisationAbbreviationFr(version.getBusinessOrganisationRelation().getBusinessOrganisationAbbreviationFr())
        .businessOrganisationAbbreviationIt(version.getBusinessOrganisationRelation().getBusinessOrganisationAbbreviationIt())
        .businessOrganisationAbbreviationEn(version.getBusinessOrganisationRelation().getBusinessOrganisationAbbreviationEn())
        .businessOrganisationDescriptionDe(version.getBusinessOrganisationRelation().getBusinessOrganisationDescriptionDe())
        .businessOrganisationDescriptionFr(version.getBusinessOrganisationRelation().getBusinessOrganisationDescriptionFr())
        .businessOrganisationDescriptionIt(version.getBusinessOrganisationRelation().getBusinessOrganisationDescriptionIt())
        .businessOrganisationDescriptionEn(version.getBusinessOrganisationRelation().getBusinessOrganisationDescriptionEn())
