...
import ch.sbb.exportservice.job.sepodi.loadingpoint.entity.LoadingPointVersion.LoadingPointVersionBuilder;
...
public class LoadingPointVersionRowMapper extends BaseSepodiRowMapper implements RowMapper<LoadingPointVersion> {
