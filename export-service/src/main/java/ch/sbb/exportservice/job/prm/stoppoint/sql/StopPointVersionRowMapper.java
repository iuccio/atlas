...
import ch.sbb.exportservice.job.prm.stoppoint.entity.StopPointVersion.StopPointVersionBuilder;
...
public class StopPointVersionRowMapper implements RowMapper<StopPointVersion> {
