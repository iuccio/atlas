package ch.sbb.exportservice.job.platform;
...
@Slf4j
public class PlatformVersionJsonProcessor extends BaseServicePointProcessor implements
    ItemProcessor<PlatformVersion, ReadPlatformVersionModel> {
