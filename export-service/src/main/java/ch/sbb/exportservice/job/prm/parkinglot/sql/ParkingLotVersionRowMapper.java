package ch.sbb.exportservice.job.prm.parkinglot.sql;

import ch.sbb.atlas.api.prm.enumeration.BooleanOptionalAttributeType;
import ch.sbb.atlas.model.Status;
import ch.sbb.atlas.servicepoint.ServicePointNumber;
import ch.sbb.exportservice.job.prm.parkinglot.entity.ParkingLotVersion;
import ch.sbb.exportservice.job.prm.parkinglot.entity.ParkingLotVersion.ParkingLotVersionBuilder;
...
public class ParkingLotVersionRowMapper implements RowMapper<ParkingLotVersion> {
