...
import ch.sbb.exportservice.job.prm.toilet.entity.ToiletVersion.ToiletVersionBuilder;
...
public class ToiletVersionRowMapper implements RowMapper<ToiletVersion> {
