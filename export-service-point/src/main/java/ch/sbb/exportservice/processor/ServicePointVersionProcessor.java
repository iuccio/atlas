...
public class ServicePointVersionProcessor implements ItemProcessor<ServicePointVersion, ServicePointVersionCsvModel> {
  ...
  public ServicePointVersionCsvModel process(ServicePointVersion version) {
    ...
    builder.stopPoint(version.isStopPoint());
    ...
    builder.meansOfTransportCode(version.getMeansOfTransportPipeList());
    builder.categoriesCode(version.getCategoriesPipeList());
    builder.operatingPointTrafficPointTypeCode(
