...
public class TrafficPointElementVersionSqlQueryUtil extends SqlQueryUtil {
  ...
  public String getSqlQuery(SePoDiExportType sePoDiExportType) {
    ...
    final String sqlQuery = getFromStatementQueryForWorldOnlyTypes(sePoDiExportType, SELECT_AND_JOIN_STATEMENT)
        + getWhereClauseForWorldOnlyTypes(sePoDiExportType, WHERE_STATEMENT)
        + GROUP_BY_STATEMENT;
