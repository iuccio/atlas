...
public class PlatformVersionRowMapper extends BaseRowMapper implements RowMapper<PlatformVersion> {
    ...
    public PlatformVersion mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        builder.sloid(removeNewLine(rs.getString("sloid")));
        builder.parentSloidServicePoint(removeNewLine(rs.getString("parent_service_point_sloid")));
        ...
        builder.boardingDevice(
                rs.getObject("boarding_device") != null ? BoardingDeviceAttributeType.valueOf(removeNewLine(rs.getString("boarding_device"))) : null);
        ...
        builder.contrastingAreas(
                rs.getObject("contrasting_areas") != null ? BooleanOptionalAttributeType.valueOf(removeNewLine(rs.getString("contrasting_areas"))) : null);
        builder.dynamicAudio(
                rs.getObject("dynamic_audio") != null ? BasicAttributeType.valueOf(removeNewLine(rs.getString("dynamic_audio"))) : null );
        builder.dynamicVisual(
                rs.getObject("dynamic_visual") != null ? BasicAttributeType.valueOf(removeNewLine(rs.getString("dynamic_visual"))) : null);
        ...
        setInfoOpportunities(builder, removeNewLine(rs.getString("info_opportunities")));
        builder.levelAccessWheelchair(
                rs.getObject("level_access_wheelchair") != null ? BasicAttributeType.valueOf(removeNewLine(rs.getString("level_access_wheelchair"))) : null);
        ...
        builder.tactileSystems(
                rs.getObject("tactile_system") != null ? BooleanOptionalAttributeType.valueOf(removeNewLine(rs.getString("tactile_system"))) : null);
        builder.vehicleAccess(
                rs.getObject("vehicle_access") != null ? VehicleAccessAttributeType.valueOf(removeNewLine(rs.getString("vehicle_access"))) : null);
