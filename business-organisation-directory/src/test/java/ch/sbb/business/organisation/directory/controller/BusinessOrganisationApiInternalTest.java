...
class BusinessOrganisationApiInternalTest extends BaseControllerApiTest {
  ...
  @Autowired
  BusinessOrganisationApiInternalTest(BusinessOrganisationVersionRepository versionRepository) {
