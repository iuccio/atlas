...
include::{snippets}/business-organisation-controller-api-test/should-get-business-organisation-versions-by-sboid/auto-section.adoc[]
...
== Export Full Business Organisation Versions Csv and Zip file to Amazon S3 Bucket

include::{snippets}/business-organisation-controller-api-test/should-export-full-business-organisation-versions-csv/auto-section.adoc[]

== Export Actual Business Organisation Versions Csv and Zip file to Amazon S3 Bucket

include::{snippets}/business-organisation-controller-api-test/should-export-actual-business-organisation-versions-csv/auto-section.adoc[]

== Export Timetable Year change Business Organisation Versions Csv and Zip file to Amazon S3 Bucket

include::{snippets}/business-organisation-controller-api-test/should-export-future-timetable-business-organisation-versions-csv/auto-section.adoc[]
