...
== Get Business Organisation Directories - Successfully
include::{snippets}/business-organisation-controller-api-test/should-gel-business-organisation-versions/auto-section.adoc[]
