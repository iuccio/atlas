package ch.sbb.business.organisation.directory.module.businessorganisation.exception;
...
import ch.sbb.business.organisation.directory.module.businessorganisation.entity.BusinessOrganisationVersion.Fields;
...
public class BusinessOrganisationConflictException extends AtlasException {
  ...
  private final transient BusinessOrganisationVersion newVersion;
  private final transient List<BusinessOrganisationVersion> overlappingVersions;
