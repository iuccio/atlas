...
public class OpenApiConfig {
  ...
  public GroupedOpenApi defaultApi() {
    return GroupedOpenApi.builder()
                         .group("public")
                         .packagesToScan("ch.sbb.business.organisation.directory")
                         .build();
  }
  ...
  public OpenAPI openAPI() {
    return new OpenAPI()
        ...
        .info(new Info()
            .title("Business Organisation Directory API")
            .description("This is the API for all your needs on business organisations")
