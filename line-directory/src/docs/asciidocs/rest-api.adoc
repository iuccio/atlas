...
include::../../../../amazon-s3/documentaion/Amazon_S3_Buckets_Users_Onboarding.md[]

== Export Full Line Versions Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-full-line-versions-csv/auto-section.adoc[]

== Export Full Line Versions Zipped Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-full-line-versions-csv-zip/auto-section.adoc[]

== Export Actual Line Versions Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-actual-line-versions-csv/auto-section.adoc[]

== Export Actual Line Versions Zipped Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-actual-line-versions-csv-zip/auto-section.adoc[]

== Export Future Timetable Line Versions Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-future-timetable-line-versions-csv/auto-section.adoc[]

== Export  Future Timetable Line Versions Zipped Csv file to Amazon S3 Bucket
...
For more information go to https://www.fahrplanfelder.ch/en/welcome.html

== Get Future Timetable

include::{snippets}/future-timetable-controller-api-test/should-return-future-time-table/auto-section.adoc[]

== Get Future Timetable - Erorr: param greater than 9999

include::{snippets}/future-timetable-controller-api-test/should-return-error-when-year-after9999/auto-section.adoc[]

== Get Future Timetable - Erorr: param smaller than 1700

include::{snippets}/future-timetable-controller-api-test/should-return-error-when-year-before1700/auto-section.adoc[]

== Get Next Future Timetables

include::{snippets}/future-timetable-controller-api-test/should-return-next-future-time-tables/auto-section.adoc[]

== Get Next Future Timetables - Error: param greater than 100

include::{snippets}/future-timetable-controller-api-test/should-return-error-when-next-future-time-tables-is-more-than-hundred/auto-section.adoc[]

== Get Next Future Timetables - Error: param smaller than 1

include::{snippets}/future-timetable-controller-api-test/should-return-error-when-next-future-time-tables-is-zero/auto-section.adoc[]
