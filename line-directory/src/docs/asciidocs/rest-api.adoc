...
== Export Timetable Year change Line Versions Csv file to Amazon S3 Bucket

include::{snippets}/line-controller-api-test/should-export-future-timetable-line-versions-csv/auto-section.adoc[]

== Export Timetable Year change Line Versions Zipped Csv file to Amazon S3 Bucket
...
include::{snippets}/user-administration-controller-api-test/should-get-user-permissions/auto-section.adoc[]
