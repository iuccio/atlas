package ch.sbb.line.directory.module.ttfn.export;
...
public class TimetableFieldNumberVersionExportService extends
  ...
  protected File getFullVersionsCsv() {
    List<TimetableFieldNumberVersion> fullTimeTableNumberVersions =
        timetableFieldNumberVersionRepository.getFullTimeTableNumberVersions();
    return createCsvFile(fullTimeTableNumberVersions, ExportType.FULL);
  }

  @Override
  protected File getActualVersionsCsv() {
    List<TimetableFieldNumberVersion> actualTimeTableNumberVersions =
        timetableFieldNumberVersionRepository.getActualTimeTableNumberVersions(
            LocalDate.now());
