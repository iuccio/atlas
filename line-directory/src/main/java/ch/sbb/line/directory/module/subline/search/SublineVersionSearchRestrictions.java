...
public class SublineVersionSearchRestrictions {
  ...
  public Specification<SublineVersion> getSpecification() {
    return new ValidOnSpecification<>(sublineVersionRequestParams.getValidOn(), SublineVersion_.validFrom,
        ...
        .and(new SingleStringSpecification<>(sublineVersionRequestParams.getSwissSublineNumber(), Fields.swissSublineNumber))
        .and(new SingleStringSpecification<>(sublineVersionRequestParams.getMainlineSlnid(), Fields.mainlineSlnid))
        .and(new SingleStringSpecification<>(sublineVersionRequestParams.getBusinessOrganisation(), Fields.businessOrganisation))
