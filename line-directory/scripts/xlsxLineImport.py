...
def main():
  ...
  xlsData = pandas.read_excel(r'line_data.xlsx')
  ...
  result_sql_file = open(
      "../src/main/resources/db/scripts/initial_line_data.sql",
      mode="w", encoding="UTF-8")
  print("Writing LiDi Data to file")
  ...
  result_sql_file.write(
      "update subline_version set mainline_slnid = line_version.slnid from line_version where line_version.swiss_line_number=subline_version.mainline_slnid;")
  result_sql_file.write(
      "delete from subline_version where mainline_slnid not like 'ch:1:slnid%';")
