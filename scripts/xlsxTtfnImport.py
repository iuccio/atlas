...
def main():
  ...
  print("Reading TTFN Data")
  xlsData = pandas.read_excel(r'ttfn_data.xlsx')
  ...
  result_sql_file = open(
      "../src/main/resources/db/scripts/initial_ttfn_data.sql", mode="w",
      encoding="UTF-8")
  print("Writing TTFN Data to file")
