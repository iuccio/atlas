package ch.sbb.prm.directory.domain.referencepoint.service;
...
import ch.sbb.prm.directory.domain.contactpoint.repository.ContactPointRepository;
...
import ch.sbb.prm.directory.domain.platform.repository.PlatformRepository;
import ch.sbb.prm.directory.domain.referencepoint.entity.ReferencePointVersion;
import ch.sbb.prm.directory.domain.referencepoint.mapper.ReferencePointVersionMapper;
import ch.sbb.prm.directory.domain.referencepoint.repository.ReferencePointRepository;
import ch.sbb.prm.directory.domain.toilet.repository.ToiletRepository;
import ch.sbb.prm.directory.domain.referencepoint.search.ReferencePointSearchRestrictions;
...
import ch.sbb.prm.directory.domain.stoppoint.service.StopPointService;
import ch.sbb.prm.directory.domain.relation.util.RelationUtil;
