package ch.sbb.prm.directory.domain.bulkimport.service;
...
import ch.sbb.prm.directory.domain.bulkimport.mapper.PlatformBulkImportUpdate;
import ch.sbb.prm.directory.domain.bulkimport.client.PlatformApiClient;
