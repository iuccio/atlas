...
public class PlatformBulkImportReducedUpdate extends
    BulkImportUpdateDataMapper<PlatformReducedUpdateCsvModel, PlatformVersion, PlatformVersionModel> {
  ...
  public static PlatformVersionModel apply(
    ...
    return new PlatformBulkImportReducedUpdate().applyUpdate(bulkImportContainer, currentVersion,
