package ch.sbb.prm.directory.domain.stoppoint.controller;
...
import ch.sbb.prm.directory.domain.stoppoint.api.StopPointApiV1;
import ch.sbb.prm.directory.domain.stoppoint.controller.model.StopPointRequestParams;
import ch.sbb.prm.directory.domain.stoppoint.entity.StopPointVersion;
import ch.sbb.prm.directory.domain.stoppoint.exception.StopPointAlreadyExistsException;
import ch.sbb.prm.directory.domain.stoppoint.mapper.StopPointVersionMapper;
import ch.sbb.prm.directory.domain.stoppoint.search.StopPointSearchRestrictions;
import ch.sbb.prm.directory.domain.platform.service.PlatformService;
