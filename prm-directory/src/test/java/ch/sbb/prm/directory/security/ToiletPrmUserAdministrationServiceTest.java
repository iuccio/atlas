...
public class ToiletPrmUserAdministrationServiceTest extends BasePrmUserAdministrationServiceTest {

    @Autowired
    public ToiletPrmUserAdministrationServiceTest(SharedServicePointRepository sharedServicePointRepository,
