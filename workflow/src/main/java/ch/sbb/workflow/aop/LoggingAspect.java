...
public class LoggingAspect {
  ...
  public enum WorkflowType {
    StopPointWorkflow("CRITICAL_STOP_POINT_WORKFLOW_ERROR"),
    StopPointTerminationWorkflow("CRITICAL_STOP_POINT_TERMINATION_WORKFLOW_ERROR"),
    TthDossierWorkflow("CRITICAL_TTH_DOSSIER_WORKFLOW_ERROR");
