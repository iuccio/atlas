...
public interface BoDiClient {
  ...
  @PostMapping(value = "/business-organisation-directory/internal/companies/loadFromCRD", produces =
      MediaType.APPLICATION_JSON_VALUE)
  Response postLoadCompaniesFromCRD();

  @PostMapping(value = "/business-organisation-directory/internal/transport-companies/loadFromBAV", produces =
      MediaType.APPLICATION_JSON_VALUE)
