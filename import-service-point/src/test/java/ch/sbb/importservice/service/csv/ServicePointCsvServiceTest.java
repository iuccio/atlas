...
class ServicePointCsvServiceTest {
  ...
  void shouldMapToServicePointCsvModelContainersWithPreMerge() {
    ...
    assertThat(servicePointCsvModelContainers.get(0).getDidokCode()).isEqualTo(85070005);
    assertThat(servicePointCsvModelContainers.get(0).getServicePointCsvModelList()).hasSize(1);
    assertThat(servicePointCsvModelContainers.get(0).getServicePointCsvModelList().get(0).getDidokCode()).isEqualTo(85070005);
    ...
    assertThat(servicePointCsvModelContainers.get(1).getDidokCode()).isEqualTo(96080001);
    assertThat(servicePointCsvModelContainers.get(1).getServicePointCsvModelList()).hasSize(1);
    assertThat(servicePointCsvModelContainers.get(1).getServicePointCsvModelList().get(0).getDidokCode()).isEqualTo(96080001);
