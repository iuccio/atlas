...
public class ContactPointMigrationActualDateIntegrationTest {
    ...
    private static final String ATLAS_CSV_FILE = "actual-date-contact_point-2024-04-08.csv";
    ...
    @Autowired
    public ContactPointMigrationActualDateIntegrationTest(ContactPointCsvService contactPointCsvService) {
