...
bootstrapApplication(AppComponent, {
    providers: [
        importProvidersFrom(CoreModule, DateModule.forRoot(), TranslateModule.forRoot({
            loader: {
                provide: TranslateLoader,
                useFactory: httpLoaderFactory,
                deps: [HttpClient],
            },
        }), AppRoutingModule, AtlasApiModule.forRoot(withBasePath(environment.atlasUnauthApiUrl)), ServiceWorkerModule.register('ngsw-worker.js', {
