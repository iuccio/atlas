...
describe('ParkingLotTableComponent', () => {
  ...
  const personWithReducedMobilityService = jasmine.createSpyObj('personWithReducedMobilityService', ['getParkingLotsOverview']);
  personWithReducedMobilityService.getParkingLotsOverview.and.returnValue(of(parkingLotOverview));
