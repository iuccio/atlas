...
describe('ContactPointTableComponent', () => {
  ...
  const personWithReducedMobilityService = jasmine.createSpyObj('personWithReducedMobilityService', ['getContactPointOverview']);
  personWithReducedMobilityService.getContactPointOverview.and.returnValue(of(contactPointOverview));
