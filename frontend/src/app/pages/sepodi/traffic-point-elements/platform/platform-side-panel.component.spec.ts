...
import { PlatformSidePanelComponent } from './platform-side-panel.component';
...
describe('TrafficPointElementsDetailComponent', () => {
  let component: PlatformSidePanelComponent;
  let fixture: ComponentFixture<PlatformSidePanelComponent>;
  ...
  describe('for existing Version', () => {
    beforeEach(async () => {
      ...
      fixture = TestBed.createComponent(PlatformSidePanelComponent);
