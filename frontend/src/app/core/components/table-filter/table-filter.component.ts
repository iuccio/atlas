...
@Component({
    ...
    imports: [NgFor, NgIf, AtlasLabelFieldComponent, NgClass, MatChipGrid, MatChipRow, MatChipRemove, MatChipInput, AtlasSlideToggleComponent, BusinessOrganisationSelectComponent, ReactiveFormsModule, TimetableFieldNumberSelectComponent, TransportCompanySelectComponent, SelectComponent, AtlasSpacerComponent, MatInput, MatDatepickerInput, MatDatepickerToggle, MatSuffix, MatIcon, MatDatepickerToggleIcon, DateIconComponent, MatDatepicker, AtlasFieldErrorComponent, InstanceOfPipe]
})
