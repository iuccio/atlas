...
@Component({
    ...
    imports: [ReactiveFormsModule, AtlasLabelFieldComponent, MatDatepickerInput, MatDatepickerToggle, MatIcon, MatDatepickerToggleIcon, DateIconComponent, MatDatepicker, AtlasFieldErrorComponent]
})
