...
export class BulkImportService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startServicePointImportBatch(application: ApplicationType, objectType: BusinessObjectType, importType: ImportType, bulkImportRequest: BulkImportRequest, file: Blob, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<any>;
    public startServicePointImportBatch(application: ApplicationType, objectType: BusinessObjectType, importType: ImportType, bulkImportRequest: BulkImportRequest, file: Blob, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<any>>;
    public startServicePointImportBatch(application: ApplicationType, objectType: BusinessObjectType, importType: ImportType, bulkImportRequest: BulkImportRequest, file: Blob, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<any>>;
    public startServicePointImportBatch(application: ApplicationType, objectType: BusinessObjectType, importType: ImportType, bulkImportRequest: BulkImportRequest, file: Blob, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (application === null || application === undefined) {
            throw new Error('Required parameter application was null or undefined when calling startServicePointImportBatch.');
        }
        if (objectType === null || objectType === undefined) {
            throw new Error('Required parameter objectType was null or undefined when calling startServicePointImportBatch.');
        }
        if (importType === null || importType === undefined) {
            throw new Error('Required parameter importType was null or undefined when calling startServicePointImportBatch.');
        }
