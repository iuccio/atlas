...
export class UserInformationService {
     ...
     */
    public searchUsers(searchQuery: string, searchInAtlas?: boolean, applicationType?: ApplicationType, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<User>>;
    public searchUsers(searchQuery: string, searchInAtlas?: boolean, applicationType?: ApplicationType, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<User>>>;
    public searchUsers(searchQuery: string, searchInAtlas?: boolean, applicationType?: ApplicationType, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<User>>>;
    public searchUsers(searchQuery: string, searchInAtlas?: boolean, applicationType?: ApplicationType, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        if (searchInAtlas !== undefined && searchInAtlas !== null) {
          queryParameters = this.addToHttpParams(queryParameters,
            <any>searchInAtlas, 'searchInAtlas');
        }
