...
export class UserInformationService {
     ...
     */
    public searchUsers(searchQuery: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<User>>;
    public searchUsers(searchQuery: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<User>>>;
    public searchUsers(searchQuery: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<User>>>;
    public searchUsers(searchQuery: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/user-administration/v1/search`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public searchUsersInAtlas(searchQuery: string, applicationType: ApplicationType, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<User>>;
    public searchUsersInAtlas(searchQuery: string, applicationType: ApplicationType, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<User>>>;
    public searchUsersInAtlas(searchQuery: string, applicationType: ApplicationType, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<User>>>;
    public searchUsersInAtlas(searchQuery: string, applicationType: ApplicationType, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (searchQuery === null || searchQuery === undefined) {
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/user-administration/v1/search-in-atlas`,
            {
                params: queryParameters,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
