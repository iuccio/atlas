...
export class StopPointWorkflowService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public filterStopPointWorkflows(page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ContainerReadStopPointWorkflow>;
    public filterStopPointWorkflows(page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ContainerReadStopPointWorkflow>>;
    public filterStopPointWorkflows(page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ContainerReadStopPointWorkflow>>;
    public filterStopPointWorkflows(page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ContainerReadStopPointWorkflow>(`${this.configuration.basePath}/workflow/v1/stop-point/workflows/filter-no-decision`,
            {
