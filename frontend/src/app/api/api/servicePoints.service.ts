...
export class ServicePointsService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public searchOnlyBpsServicePoints(
    isBps: boolean,
  ...
  public searchOnlyBpsServicePoints(
    ...
    if (isBps === null || isBps === undefined) {
      throw new Error(
        'Required parameter isBps was null or undefined when calling searchOnlyBpsServicePoints.',
      );
    }
    if (servicePointSearchRequest === null || servicePointSearchRequest === undefined) {
      throw new Error(
        'Required parameter servicePointSearchRequest was null or undefined when calling searchOnlyBpsServicePoints.',
      );
    }

    let queryParameters = new HttpParams({ encoder: this.encoder });
    if (isBps !== undefined && isBps !== null) {
      queryParameters = this.addToHttpParams(queryParameters, <any>isBps, 'isBps');
    }
    ...
    return this.httpClient.post<Array<ServicePointSearchResult>>(
      `${this.configuration.basePath}/service-point-directory/v1/service-points/search-bps`,
  ...
  public updateServicePoint(
    ...
    if (createServicePointVersion === null || createServicePointVersion === undefined) {
      throw new Error(
        'Required parameter createServicePointVersion was null or undefined when calling updateServicePoint.',
      );
    }
