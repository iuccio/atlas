 ...
 *
<<<<<<< HEAD
 * The version of the OpenAPI document: 1.478.0
=======
...
import { ServicePointFotCommentModel } from '../model/models';
...
export class ServicePointsService {
  ...
  public getFotComment(
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<ServicePointFotCommentModel>;
  public getFotComment(
    servicePointNumber: number,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpResponse<ServicePointFotCommentModel>>;
  public getFotComment(
    servicePointNumber: number,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpEvent<ServicePointFotCommentModel>>;
  public getFotComment(
    servicePointNumber: number,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    return this.httpClient.get<ServicePointFotCommentModel>(
      `${
  ...
  /**
   * @param servicePointNumber
   * @param servicePointFotCommentModel
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public saveFotComment(
    servicePointNumber: number,
    servicePointFotCommentModel: ServicePointFotCommentModel,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<ServicePointFotCommentModel>;
  ...
  public saveFotComment(
    ...
    if (servicePointFotCommentModel === null || servicePointFotCommentModel === undefined) {
      throw new Error(
        'Required parameter servicePointFotCommentModel was null or undefined when calling saveFotComment.',
      );
    }
    ...
    return this.httpClient.put<ServicePointFotCommentModel>(
      `${
        this.configuration.basePath
      }/service-point-directory/v1/service-points/${encodeURIComponent(
        String(servicePointNumber),
      )}/fot-comment`,
      servicePointFotCommentModel,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
