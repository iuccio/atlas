...
export class TimetableFieldNumbersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getOverview(searchCriteria?: Array<string>, businessOrganisation?: string, validOn?: Date, statusChoices?: Array<Status>, page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ContainerTimetableFieldNumber>;
    public getOverview(searchCriteria?: Array<string>, businessOrganisation?: string, validOn?: Date, statusChoices?: Array<Status>, page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ContainerTimetableFieldNumber>>;
    public getOverview(searchCriteria?: Array<string>, businessOrganisation?: string, validOn?: Date, statusChoices?: Array<Status>, page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ContainerTimetableFieldNumber>>;
    public getOverview(searchCriteria?: Array<string>, businessOrganisation?: string, validOn?: Date, statusChoices?: Array<Status>, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
