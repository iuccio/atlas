...
// @ts-ignore
import { BulkImportUpdateContainerServicePointUpdateCsvModel } from '../model/bulkImportUpdateContainerServicePointUpdateCsvModel';
// @ts-ignore
...
export class ServicePointsBulkImportService {
     ...
     */
    public bulkImportUpdate1(bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<Array<BulkImportItemExecutionResult>>;
    public bulkImportUpdate1(bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<Array<BulkImportItemExecutionResult>>>;
    public bulkImportUpdate1(bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<Array<BulkImportItemExecutionResult>>>;
    public bulkImportUpdate1(bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        ...
        let localVarPath = `/service-point-directory/v1/service-points/bulk-import/update`;
        return this.httpClient.request<Array<BulkImportItemExecutionResult>>('post', `${this.configuration.basePath}${localVarPath}`,
            {
                context: localVarHttpContext,
                body: bulkImportUpdateContainerServicePointUpdateCsvModel,
