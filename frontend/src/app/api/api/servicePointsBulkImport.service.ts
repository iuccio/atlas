...
export class ServicePointsBulkImportService {
     ...
     */
    public bulkImportUpdate(userName: string, bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<BulkImportItemExecutionResult>>;
    public bulkImportUpdate(userName: string, bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<BulkImportItemExecutionResult>>>;
    public bulkImportUpdate(userName: string, bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<BulkImportItemExecutionResult>>>;
    public bulkImportUpdate(userName: string, bulkImportUpdateContainerServicePointUpdateCsvModel: Array<BulkImportUpdateContainerServicePointUpdateCsvModel>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (userName === null || userName === undefined) {
            throw new Error('Required parameter userName was null or undefined when calling bulkImportUpdate.');
        }
        ...
        return this.httpClient.post<Array<BulkImportItemExecutionResult>>(`${this.configuration.basePath}/service-point-directory/v1/service-points/bulk-import/update/${encodeURIComponent(String(userName))}`,
