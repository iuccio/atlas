...
export class TimetableHearingStatementsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createStatementExternal(inlineObject2?: InlineObject2, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatementV2>;
    public createStatementExternal(inlineObject2?: InlineObject2, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatementV2>>;
    public createStatementExternal(inlineObject2?: InlineObject2, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatementV2>>;
    public createStatementExternal(inlineObject2?: InlineObject2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createStatementExternal1(inlineObject3?: InlineObject3, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatement>;
    public createStatementExternal1(inlineObject3?: InlineObject3, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatement>>;
    public createStatementExternal1(inlineObject3?: InlineObject3, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatement>>;
    public createStatementExternal1(inlineObject3?: InlineObject3, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
