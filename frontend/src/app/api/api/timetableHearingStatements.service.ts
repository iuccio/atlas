...
export class TimetableHearingStatementsService {
     ...
     */
    public createStatement(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatement>;
    public createStatement(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatement>>;
    public createStatement(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatement>>;
    public createStatement(statement: TimetableHearingStatement, documents?: Array<Blob>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<TimetableHearingStatement>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public createStatementExternal(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatement>;
    public createStatementExternal(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatement>>;
    public createStatementExternal(statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatement>>;
    public createStatementExternal(statement: TimetableHearingStatement, documents?: Array<Blob>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (statement === null || statement === undefined) {
    ...
    public deleteStatementDocument(id: number, filename: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.delete<any>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}/documents/${encodeURIComponent(String(filename))}`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getNextStatement(id: number, timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<TimetableHearingStatementAlternating>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}/next`,
            {
    ...
    public getPreviousStatement(id: number, timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<TimetableHearingStatementAlternating>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}/previous`,
            {
                params: queryParameters,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getResponsibleTransportCompanies(ttfnid: string, year: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<Array<TransportCompany>>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/responsible-transport-companies/${encodeURIComponent(String(ttfnid))}/${encodeURIComponent(String(year))}`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getStatement(id: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatement>;
    public getStatement(id: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatement>>;
    public getStatement(id: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatement>>;
    public getStatement(id: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<TimetableHearingStatement>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}`,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
    ...
    public getStatementDocument(id: number, filename: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*' | 'application/pdf'}): Observable<any> {
        ...
        return this.httpClient.get(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}/documents/${encodeURIComponent(String(filename))}`,
            {
                responseType: "blob",
                withCredentials: this.configuration.withCredentials,
                headers: headers,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getStatements(timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ContainerTimetableHearingStatement>;
    public getStatements(timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ContainerTimetableHearingStatement>>;
    public getStatements(timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ContainerTimetableHearingStatement>>;
    public getStatements(timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.get<ContainerTimetableHearingStatement>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements`,
            {
                params: queryParameters,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public getStatementsAsCsv(language: string, timetableHearingYear?: number, canton?: SwissCanton, searchCriterias?: Array<string>, statusRestrictions?: Array<StatementStatus>, ttfnid?: string, transportCompanies?: Array<number>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*' | 'application/octet-stream'}): Observable<any> {
        ...
        return this.httpClient.get(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/csv/${encodeURIComponent(String(language))}`,
            {
                params: queryParameters,
                responseType: "blob",
                withCredentials: this.configuration.withCredentials,
    ...
    public updateHearingCanton(updateHearingCanton: UpdateHearingCanton, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/update-canton`,
            updateHearingCanton,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateHearingStatement(id: number, statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<TimetableHearingStatement>;
    public updateHearingStatement(id: number, statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<TimetableHearingStatement>>;
    public updateHearingStatement(id: number, statement: TimetableHearingStatement, documents?: Array<Blob>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<TimetableHearingStatement>>;
    public updateHearingStatement(id: number, statement: TimetableHearingStatement, documents?: Array<Blob>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return this.httpClient.put<TimetableHearingStatement>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/${encodeURIComponent(String(id))}`,
            convertFormParamsToString ? formParams.toString() : formParams,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
    ...
    public updateHearingStatementStatus(updateHearingStatementStatus: UpdateHearingStatementStatus, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.put<any>(`${this.configuration.basePath}/line-directory/v1/timetable-hearing/statements/update-statement-status`,
