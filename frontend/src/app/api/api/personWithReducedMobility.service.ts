 ...
 *
<<<<<<< HEAD:frontend/src/app/api/api/personWithReducedMobility.service.ts
 * The version of the OpenAPI document: 1.478.0
=======
 * The version of the OpenAPI document: 1.470.0
>>>>>>> 0d5a2f109 (ATLAS-1307: Write type enum to DB):frontend/src/app/api/api/pRMPersonWithReducedMobility.service.ts
