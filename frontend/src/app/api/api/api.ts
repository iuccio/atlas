...
export * from './servicePointsBulkImport.service';
import { ServicePointsBulkImportService } from './servicePointsBulkImport.service';
...
export * from './trafficPointsBulkImport.service';
import { TrafficPointsBulkImportService } from './trafficPointsBulkImport.service';
...
export const APIS = [BulkImportService, BusinessOrganisationsService, ClientCredentialAdministrationService, CompaniesService, ExportServicePointBatchService, GeoDataService, LinesService, LoadingPointsService, PersonWithReducedMobilityService, PersonWithReducedMobilityExportService, PlatformBulkImportService, ServicePointUpdateGeoService, ServicePointsService, ServicePointsBulkImportService, StopPointWorkflowService, SublinesService, TimetableFieldNumbersService, TimetableHearingStatementsService, TimetableHearingYearsService, TimetableYearChangeService, TrafficPointElementsService, TrafficPointsBulkImportService, TransportCompaniesService, TransportCompanyRelationsService, UserAdministrationService, UserInformationService, WorkflowService];
