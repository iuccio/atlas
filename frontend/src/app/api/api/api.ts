...
export * from './businessOrganisationsExport.service';
import { BusinessOrganisationsExportService } from './businessOrganisationsExport.service';
...
export const APIS = [BulkImportService, BusinessOrganisationsService, BusinessOrganisationsExportService, ClientCredentialAdministrationService, CompaniesService, ExportServicePointBatchService, GeoDataService, LinesService, LoadingPointsService, PersonWithReducedMobilityService, PersonWithReducedMobilityExportService, PlatformBulkImportService, ServicePointBulkImportService, ServicePointUpdateGeoService, ServicePointsService, StopPointWorkflowService, SublinesService, TimetableFieldNumbersService, TimetableHearingStatementsService, TimetableHearingYearsService, TimetableYearChangeService, TrafficPointElementBulkImportService, TrafficPointElementsService, TransportCompaniesService, TransportCompanyRelationsService, UserAdministrationService, UserInformationService, WorkflowService];
