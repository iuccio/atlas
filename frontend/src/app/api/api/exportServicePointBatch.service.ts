...
export class ExportServicePointBatchService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public streamExportGzFile1(
    exportFileName: SePoDiBatchExportFileName,
    sePoDiExportType: SePoDiExportType,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<object>;
  ...
  public streamExportGzFile1(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamExportGzFile1.',
      );
    }
    if (sePoDiExportType === null || sePoDiExportType === undefined) {
      throw new Error(
        'Required parameter sePoDiExportType was null or undefined when calling streamExportGzFile1.',
      );
    }
    ...
    return this.httpClient.get<object>(
      ...
      )}/${encodeURIComponent(String(sePoDiExportType))}`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public streamExportJsonFile1(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamExportJsonFile1.',
      );
    }
    if (sePoDiExportType === null || sePoDiExportType === undefined) {
      throw new Error(
        'Required parameter sePoDiExportType was null or undefined when calling streamExportJsonFile1.',
      );
    }
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public streamLatestExportGzFile1(
    exportFileName: SePoDiBatchExportFileName,
    sePoDiExportType: SePoDiExportType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public streamLatestExportGzFile1(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamLatestExportGzFile1.',
      );
    }
    if (sePoDiExportType === null || sePoDiExportType === undefined) {
      throw new Error(
        'Required parameter sePoDiExportType was null or undefined when calling streamLatestExportGzFile1.',
      );
    }
    ...
    return this.httpClient.get<object>(
      `${
        this.configuration.basePath
      }/export-service-point/v1/export/download-gzip-json/latest/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(sePoDiExportType))}`,
      {
        responseType: <any>responseType_,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public streamLatestExportJsonFile1(
    exportFileName: SePoDiBatchExportFileName,
    sePoDiExportType: SePoDiExportType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public streamLatestExportJsonFile1(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamLatestExportJsonFile1.',
      );
    }
    if (sePoDiExportType === null || sePoDiExportType === undefined) {
      throw new Error(
        'Required parameter sePoDiExportType was null or undefined when calling streamLatestExportJsonFile1.',
      );
    }
    ...
    return this.httpClient.get<object>(
      `${
        this.configuration.basePath
      }/export-service-point/v1/export/json/latest/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(sePoDiExportType))}`,
      {
        responseType: <any>responseType_,
