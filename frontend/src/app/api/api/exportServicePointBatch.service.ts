...
import { ExportFileName } from '../model/models';
...
export class ExportServicePointBatchService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public startExportTrafficPointElementJsonBatch(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' }
  ): Observable<any>;
  ...
  public streamGzipFile(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamGzipFile.'
      );
    }
  ...
  public streamJsonFile(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamJsonFile.'
      );
    }
    if (exportType === null || exportType === undefined) {
      throw new Error(
