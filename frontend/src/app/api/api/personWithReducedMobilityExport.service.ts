...
export class PersonWithReducedMobilityExportService {
   ...
   */
  public startExportContactPointBatch(
    observe?: 'body',
  ...
  public startExportContactPointBatch(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/contact-point-batch`,
      null,
      {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public startExportPlatformBatch(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<any>;
  ...
  public startExportPlatformBatch(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/platform-batch`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public startExportReferencePointBatch(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<any>;
  ...
  public startExportReferencePointBatch(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/reference-point-batch`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public startExportStopPointBatch(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<any>;
  ...
  public startExportStopPointBatch(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/stop-point-batch`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public startExportToiletBatch(
    ...
    return this.httpClient.post<any>(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/toilet-batch`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public streamExportGzFile(
    exportFileName: PrmBatchExportFileName,
    prmExportType: PrmExportType,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<Blob>;
  ...
  public streamExportGzFile(
    ...
    if (prmExportType === null || prmExportType === undefined) {
      throw new Error(
        'Required parameter prmExportType was null or undefined when calling streamExportGzFile.',
      );
    }
    ...
    return this.httpClient.get(
      ...
      }/export-service-point/v1/export/prm/download-gzip-json/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(prmExportType))}`,
      {
        responseType: 'blob',
        withCredentials: this.configuration.withCredentials,
        headers: headers,
  ...
  public streamExportJsonFile(
    ...
    if (prmExportType === null || prmExportType === undefined) {
      throw new Error(
        'Required parameter prmExportType was null or undefined when calling streamExportJsonFile.',
      );
    }
    ...
    return this.httpClient.get(
      `${this.configuration.basePath}/export-service-point/v1/export/prm/json/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(prmExportType))}`,
      {
        responseType: 'blob',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public streamLatestExportGzFile(
    exportFileName: PrmBatchExportFileName,
    prmExportType: PrmExportType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public streamLatestExportGzFile(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamLatestExportGzFile.',
      );
    }
    if (prmExportType === null || prmExportType === undefined) {
      throw new Error(
        'Required parameter prmExportType was null or undefined when calling streamLatestExportGzFile.',
      );
    }
    ...
    return this.httpClient.get(
      `${
        this.configuration.basePath
      }/export-service-point/v1/export/prm/download-gzip-json/latest/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(prmExportType))}`,
      {
        responseType: 'blob',
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public streamLatestExportJsonFile(
    exportFileName: PrmBatchExportFileName,
    prmExportType: PrmExportType,
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public streamLatestExportJsonFile(
    ...
    if (exportFileName === null || exportFileName === undefined) {
      throw new Error(
        'Required parameter exportFileName was null or undefined when calling streamLatestExportJsonFile.',
      );
    }
    if (prmExportType === null || prmExportType === undefined) {
      throw new Error(
        'Required parameter prmExportType was null or undefined when calling streamLatestExportJsonFile.',
      );
    }
    ...
    return this.httpClient.get(
      `${
        this.configuration.basePath
      }/export-service-point/v1/export/prm/json/latest/${encodeURIComponent(
        String(exportFileName),
      )}/${encodeURIComponent(String(prmExportType))}`,
      {
        responseType: 'blob',
