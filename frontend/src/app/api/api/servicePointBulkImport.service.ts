...
export class ServicePointBulkImportService {
     ...
     */
    public bulkImportCreate1(bulkImportUpdateContainerServicePointCreateCsvModel: Array<BulkImportUpdateContainerServicePointCreateCsvModel>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<BulkImportItemExecutionResult>>;
    public bulkImportCreate1(bulkImportUpdateContainerServicePointCreateCsvModel: Array<BulkImportUpdateContainerServicePointCreateCsvModel>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<BulkImportItemExecutionResult>>>;
    public bulkImportCreate1(bulkImportUpdateContainerServicePointCreateCsvModel: Array<BulkImportUpdateContainerServicePointCreateCsvModel>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<BulkImportItemExecutionResult>>>;
    public bulkImportCreate1(bulkImportUpdateContainerServicePointCreateCsvModel: Array<BulkImportUpdateContainerServicePointCreateCsvModel>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (bulkImportUpdateContainerServicePointCreateCsvModel === null || bulkImportUpdateContainerServicePointCreateCsvModel === undefined) {
            throw new Error('Required parameter bulkImportUpdateContainerServicePointCreateCsvModel was null or undefined when calling bulkImportCreate1.');
        }
