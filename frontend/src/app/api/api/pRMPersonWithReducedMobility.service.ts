...
import { CreateStopPlaceVersion } from '../model/models';
...
import { ReadStopPlaceVersion } from '../model/models';
...
export class PRMPersonWithReducedMobilityService {
  ...
  /**
   * @param createStopPlaceVersion
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public createStopPlace(
    createStopPlaceVersion: CreateStopPlaceVersion,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<ReadStopPlaceVersion>;
  public createStopPlace(
    createStopPlaceVersion: CreateStopPlaceVersion,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpResponse<ReadStopPlaceVersion>>;
  public createStopPlace(
    createStopPlaceVersion: CreateStopPlaceVersion,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpEvent<ReadStopPlaceVersion>>;
  public createStopPlace(
    createStopPlaceVersion: CreateStopPlaceVersion,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (createStopPlaceVersion === null || createStopPlaceVersion === undefined) {
      throw new Error(
        'Required parameter createStopPlaceVersion was null or undefined when calling createStopPlace.',
      );
    }
    ...
    return this.httpClient.post<ReadStopPlaceVersion>(
      `${this.configuration.basePath}/prm-directory/v1/stop-places`,
      createStopPlaceVersion,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getAllStopPaces(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<Array<ReadStopPlaceVersion>>;
  public getAllStopPaces(
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpResponse<Array<ReadStopPlaceVersion>>>;
  public getAllStopPaces(
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' },
  ): Observable<HttpEvent<Array<ReadStopPlaceVersion>>>;
  public getAllStopPaces(
    observe: any = 'body',
    reportProgress: boolean = false,
    options?: { httpHeaderAccept?: '*/*' },
    ...
    return this.httpClient.get<Array<ReadStopPlaceVersion>>(
      `${this.configuration.basePath}/prm-directory/v1/stop-places`,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  public updateRelation(
    ...
    if (createReferencePointVersion === null || createReferencePointVersion === undefined) {
      throw new Error(
        'Required parameter createReferencePointVersion was null or undefined when calling updateRelation.',
      );
    }
  ...
  public updateStopPlace(
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling updateStopPlace.');
    }
    if (createStopPlaceVersion === null || createStopPlaceVersion === undefined) {
      throw new Error(
        'Required parameter createStopPlaceVersion was null or undefined when calling updateStopPlace.',
      );
    }
    ...
    return this.httpClient.put<Array<ReadStopPlaceVersion>>(
      `${this.configuration.basePath}/prm-directory/v1/stop-places/${encodeURIComponent(
        String(id),
      )}`,
      createStopPlaceVersion,
      {
