...
export class LinesService {
  ...
  /**
   * Export all actual line versions as csv file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportActualLineVersionsCsv(
    observe?: 'body',
    reportProgress?: boolean,
  ...
  public exportActualLineVersionsCsv(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/actual/csv`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Export all actual line versions as zip file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportActualLineVersionsCsvZip(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportActualLineVersionsCsvZip(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/actual/zip`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Export all line versions as csv file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportFullLineVersionsCsv(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportFullLineVersionsCsv(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/full/csv`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Export all line versions as zip file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportFullLineVersionsCsvZip(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportFullLineVersionsCsvZip(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/full/zip`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Export all line versions for the current timetable year change as csv file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportFutureTimetableLineVersionsCsv(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportFutureTimetableLineVersionsCsv(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/timetable-year-change/csv`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
  ...
  /**
   * Export all line versions for the current timetable year change as zip file to the ATLAS Amazon S3 Bucket
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
   */
  public exportFutureTimetableLineVersionsCsvZip(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportFutureTimetableLineVersionsCsvZip(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/timetable-year-change/zip`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
