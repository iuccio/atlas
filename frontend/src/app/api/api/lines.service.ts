...
export class LinesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LidiElementType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ContainerLine>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LidiElementType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ContainerLine>>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LidiElementType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ContainerLine>>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LidiElementType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
    ...
    public updateLineVersion(id: number, updateLineVersionV2: UpdateLineVersionV2, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<Array<LineVersionV2>>(`${this.configuration.basePath}/line-directory/v2/lines/versions/${encodeURIComponent(String(id))}`,
            updateLineVersionV2,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateLineVersion1(id: number, lineVersion: LineVersion, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<LineVersion>>;
    public updateLineVersion1(id: number, lineVersion: LineVersion, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<LineVersion>>>;
    public updateLineVersion1(id: number, lineVersion: LineVersion, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<LineVersion>>>;
    public updateLineVersion1(id: number, lineVersion: LineVersion, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling updateLineVersion1.');
        }
        if (lineVersion === null || lineVersion === undefined) {
            throw new Error('Required parameter lineVersion was null or undefined when calling updateLineVersion1.');
        }
