/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:0.487.0-SNAPSHOT<br/>business-organisation-directory:0.487.0-SNAPSHOT<br/>user-administration:0.487.0-SNAPSHOT<br/>
 *
 * The version of the OpenAPI document: 0.487.0-SNAPSHOT
...
export class LinesService {
  ...
  public exportFutureTimetableLineVersionsCsvZip(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/future-timetable/zip`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public exportFutureTimetableVersionsCsv(
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: '*/*' | 'application/json' }
  ): Observable<string>;
  ...
  public exportFutureTimetableVersionsCsv(
    ...
    return this.httpClient.post<string>(
      `${this.configuration.basePath}/line-directory/v1/lines/export-csv/future-timetable/csv`,
      null,
      {
        responseType: <any>responseType_,
        withCredentials: this.configuration.withCredentials,
