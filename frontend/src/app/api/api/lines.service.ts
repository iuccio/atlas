...
export class LinesService {
     ...
     */
    public createLineVersion(lineVersion: LineVersion, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<LineVersion>;
    public createLineVersion(lineVersion: LineVersion, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<LineVersion>>;
    public createLineVersion(lineVersion: LineVersion, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<LineVersion>>;
    public createLineVersion(lineVersion: LineVersion, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<LineVersion>(`${this.configuration.basePath}/line-directory/v1/lines/versions`,
            lineVersion,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LineType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<ContainerLine>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LineType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<ContainerLine>>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LineType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<ContainerLine>>;
    public getLines(swissLineNumber?: string, searchCriteria?: Array<string>, statusRestrictions?: Array<Status>, typeRestrictions?: Array<LineType>, businessOrganisation?: string, validOn?: Date, page?: number, size?: number, sort?: Array<string>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public revokeLine(slnid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<LineVersion>>;
    public revokeLine(slnid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<LineVersion>>>;
    public revokeLine(slnid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<LineVersion>>>;
    public revokeLine(slnid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<Array<LineVersion>>(`${this.configuration.basePath}/line-directory/v1/lines/${encodeURIComponent(String(slnid))}/revoke`,
            null,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateLineVersion(id: number, lineVersion: LineVersion, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<LineVersion>>;
    public updateLineVersion(id: number, lineVersion: LineVersion, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<LineVersion>>>;
    public updateLineVersion(id: number, lineVersion: LineVersion, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<LineVersion>>>;
    public updateLineVersion(id: number, lineVersion: LineVersion, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (id === null || id === undefined) {
        ...
        return this.httpClient.post<Array<LineVersion>>(`${this.configuration.basePath}/line-directory/v1/lines/versions/${encodeURIComponent(String(id))}`,
            lineVersion,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
