...
export class ImportDidokUserBatchService {
     ...
     */
    public startDidokPrmUserImport(inlineObject6?: InlineObject6, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<string>;
    public startDidokPrmUserImport(inlineObject6?: InlineObject6, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<string>>;
    public startDidokPrmUserImport(inlineObject6?: InlineObject6, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<string>>;
    public startDidokPrmUserImport(inlineObject6?: InlineObject6, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startDidokSePoDiUserImport(inlineObject5?: InlineObject5, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<string>;
    public startDidokSePoDiUserImport(inlineObject5?: InlineObject5, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<string>>;
    public startDidokSePoDiUserImport(inlineObject5?: InlineObject5, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<string>>;
    public startDidokSePoDiUserImport(inlineObject5?: InlineObject5, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
