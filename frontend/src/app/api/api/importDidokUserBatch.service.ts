...
export class ImportDidokUserBatchService {
     ...
     */
    public startDidokPrmUserImport(inlineObject7?: InlineObject7, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<string>;
    public startDidokPrmUserImport(inlineObject7?: InlineObject7, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<string>>;
    public startDidokPrmUserImport(inlineObject7?: InlineObject7, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<string>>;
    public startDidokPrmUserImport(inlineObject7?: InlineObject7, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/import-service-point/v1/import/maintenance/didok-prm-user`,
            inlineObject7,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public startDidokSePoDiUserImport(inlineObject6?: InlineObject6, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<string>;
    public startDidokSePoDiUserImport(inlineObject6?: InlineObject6, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<string>>;
    public startDidokSePoDiUserImport(inlineObject6?: InlineObject6, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<string>>;
    public startDidokSePoDiUserImport(inlineObject6?: InlineObject6, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        ...
        return this.httpClient.post<string>(`${this.configuration.basePath}/import-service-point/v1/import/maintenance/didok-sepodi-user`,
            inlineObject6,
            {
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
