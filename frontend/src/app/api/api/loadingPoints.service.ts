...
export class LoadingPointsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public importLoadingPoints(loadingPointImportRequest: LoadingPointImportRequest, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<Array<ItemImportResult>>;
    public importLoadingPoints(loadingPointImportRequest: LoadingPointImportRequest, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpResponse<Array<ItemImportResult>>>;
    public importLoadingPoints(loadingPointImportRequest: LoadingPointImportRequest, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: '*/*'}): Observable<HttpEvent<Array<ItemImportResult>>>;
    public importLoadingPoints(loadingPointImportRequest: LoadingPointImportRequest, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: '*/*'}): Observable<any> {
        if (loadingPointImportRequest === null || loadingPointImportRequest === undefined) {
            throw new Error('Required parameter loadingPointImportRequest was null or undefined when calling importLoadingPoints.');
        }
        ...
        return this.httpClient.post<Array<ItemImportResult>>(`${this.configuration.basePath}/service-point-directory/v1/loading-points/import`,
