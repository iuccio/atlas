/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:1.41.0-SNAPSHOT<br/>business-organisation-directory:1.41.0-SNAPSHOT<br/>user-administration:1.42.0-SNAPSHOT<br/>
 *
 * The version of the OpenAPI document: 1.42.0-SNAPSHOT
