/**
 * Atlas API
 * This is the API for all your needs SKI core data<br/><br/>Atlas serves the following applications:<br/>line-directory:0.396.0-SNAPSHOT<br/>
 *
 * The version of the OpenAPI document: 0.396.0-SNAPSHOT
