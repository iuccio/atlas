...
export type PrmBatchExportFileName = 'STOP_POINT_VERSION' | 'PLATFORM_VERSION' | 'REFERENCE_POINT_VERSION' | 'CONTACT_POINT_VERSION' | 'TOILET_VERSION' | 'PARKING_LOT_VERSION' | 'RELATION_VERSION';

export const PrmBatchExportFileName = {
    StopPointVersion: 'STOP_POINT_VERSION' as PrmBatchExportFileName,
    PlatformVersion: 'PLATFORM_VERSION' as PrmBatchExportFileName,
    ReferencePointVersion: 'REFERENCE_POINT_VERSION' as PrmBatchExportFileName,
    ContactPointVersion: 'CONTACT_POINT_VERSION' as PrmBatchExportFileName,
    ToiletVersion: 'TOILET_VERSION' as PrmBatchExportFileName,
    ParkingLotVersion: 'PARKING_LOT_VERSION' as PrmBatchExportFileName,
    RelationVersion: 'RELATION_VERSION' as PrmBatchExportFileName
};
