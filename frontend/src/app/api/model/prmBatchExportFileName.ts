...
export type PrmBatchExportFileName = 'STOP_POINT_VERSION' | 'PLATFORM_VERSION' | 'REFERENCE_POINT_VERSION' | 'CONTACT_POINT_VERSION' | 'TOILET_VERSION' | 'PARKING_LOT_VERSION';
