 ...
 */
import { TrafficPointCsvModelContainer } from './trafficPointCsvModelContainer';

export interface TrafficPointImportRequest {
  List_of_TrafficPointContainers_to_import: Array<TrafficPointCsvModelContainer>;
}
