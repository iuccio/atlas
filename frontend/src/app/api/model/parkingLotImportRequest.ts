 ...
 */
import { ParkingLotCsvModelContainer } from './parkingLotCsvModelContainer';

export interface ParkingLotImportRequest {
  List_of_parkingLotCsvModelContainers_to_import: Array<ParkingLotCsvModelContainer>;
}
