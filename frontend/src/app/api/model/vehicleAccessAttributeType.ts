...
/**
 * Access to the platform. Getting into the vehicle
 */
export type VehicleAccessAttributeType =
  | 'TO_BE_COMPLETED'
...
export const VehicleAccessAttributeType = {
  ...
  PlatformAccessWithoutAssistance:
    'PLATFORM_ACCESS_WITHOUT_ASSISTANCE' as VehicleAccessAttributeType,
  PlatformAccessWithAssistance: 'PLATFORM_ACCESS_WITH_ASSISTANCE' as VehicleAccessAttributeType,
  PlatformAccessWithAssistanceWhenNotified:
    'PLATFORM_ACCESS_WITH_ASSISTANCE_WHEN_NOTIFIED' as VehicleAccessAttributeType,
  PlatformNotWheelchairAccessible:
    'PLATFORM_NOT_WHEELCHAIR_ACCESSIBLE' as VehicleAccessAttributeType,
};
