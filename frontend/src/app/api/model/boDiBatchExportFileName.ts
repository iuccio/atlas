...
export type BoDiBatchExportFileName = 'TRANSPORT_COMPANY';

export const BoDiBatchExportFileName = {
    TransportCompany: 'TRANSPORT_COMPANY' as BoDiBatchExportFileName
};
