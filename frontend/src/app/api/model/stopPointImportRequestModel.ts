 ...
 */
import { StopPointCsvModelContainer } from './stopPointCsvModelContainer';

export interface StopPointImportRequestModel {
  List_of_StopPointCsvModelContainer_to_import: Array<StopPointCsvModelContainer>;
}
