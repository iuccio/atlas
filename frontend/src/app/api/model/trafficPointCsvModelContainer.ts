 ...
 */
import { TrafficPointElementCsvModel } from './trafficPointElementCsvModel';

export interface TrafficPointCsvModelContainer {
  sloid?: string;
  trafficPointCsvModelList?: Array<TrafficPointElementCsvModel>;
}
