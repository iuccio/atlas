...
/**
 * Reference Point Element Type
 */
export type ReferencePointElementType =
  | 'PLATFORM'
  | 'TICKET_COUNTER'
  | 'INFORMATION_DESK'
  | 'TOILET'
...
export const ReferencePointElementType = {
  ...
  TicketCounter: 'TICKET_COUNTER' as ReferencePointElementType,
  InformationDesk: 'INFORMATION_DESK' as ReferencePointElementType,
