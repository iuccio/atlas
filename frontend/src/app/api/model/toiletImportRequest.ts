 ...
 */
import { ToiletCsvModelContainer } from './toiletCsvModelContainer';

export interface ToiletImportRequest {
  List_of_ToiletCsvModelContainer_to_import: Array<ToiletCsvModelContainer>;
}
