 ...
 */
import { ReferencePointCsvModelContainer } from './referencePointCsvModelContainer';

export interface ReferencePointImportRequest {
  List_of_ReferencePointCsvModelContainer_to_import: Array<ReferencePointCsvModelContainer>;
}
