 ...
 */
import { UpdateLineVersionV2 } from './updateLineVersionV2';


export interface ShortenSubline { 
    updateLineVersionModelV2?: UpdateLineVersionV2;
