...
export type PrmExportType = 'FULL' | 'ACTUAL' | 'TIMETABLE_FUTURE';

export const PrmExportType = {
  Full: 'FULL' as PrmExportType,
  Actual: 'ACTUAL' as PrmExportType,
  TimetableFuture: 'TIMETABLE_FUTURE' as PrmExportType,
};
