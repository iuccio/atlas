...
export type SePoDiBatchExportFileName = 'SERVICE_POINT_VERSION' | 'TRAFFIC_POINT_ELEMENT_VERSION' | 'LOADING_POINT_VERSION';

export const SePoDiBatchExportFileName = {
    ServicePointVersion: 'SERVICE_POINT_VERSION' as SePoDiBatchExportFileName,
    TrafficPointElementVersion: 'TRAFFIC_POINT_ELEMENT_VERSION' as SePoDiBatchExportFileName,
    LoadingPointVersion: 'LOADING_POINT_VERSION' as SePoDiBatchExportFileName
};
